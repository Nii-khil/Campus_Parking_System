...
//  };
//
//  // Call API to renew permit
//  const handleRenew = async (id) => {
//    try {
//      const permitToRenew = permits.find((permit) => permit.permit_id === id);
//      const response = await fetch('http://localhost:3001/renew-permit', {
//        method: 'PUT',
//        headers: {
//          'Content-Type': 'application/json',
//        },
...
//          prevPermits.map((permit) =>
//            permit.permit_id === id
//              ? { ...permit, status: 'Active', expiry_date: '2024-12-31' } // Assuming a fixed new expiry date
//              : permit
//          )
//        );
...
//                <td className="border p-2">{permit.permit_name}</td>
//                <td className="border p-2">{permit.expiry_date}</td>
